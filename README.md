...
lessons/
  official/          bundled lessons (tracked in git)
    ...
    graphics/vulkan/...
    graphics/shader-ide/01-shader-ide-overview/concept.md
    graphics/shader-ide/01-shader-ide-overview/code.md
    graphics/shader-ide/...
    systems/arch-setup/01-arch-install-disk/concept.md
    systems/arch-setup/01-arch-install-disk/code.md
    systems/arch-setup/...
    webdev/nextjs/...
